...
const GetStarted = ()=>{
    return(
        <>
            <div className="flex flex-col items-center my-20 sm:mx-10">
                <div className="flex sm:flex-col justify-between sm:w-full">
                ...
                <div className="flex sm:flex-col justify-between my-10 sm:w-full">
                    <img src={images.started2} alt="female picture" className="w-[458px] sm:w-fit h-[375px] sm:h-fit" />
                    <div className="flex flex-col ml-20 sm:ml-0">
                ...
                <div className="flex sm:flex-col justify-between sm:w-full">
                    ...
                    <img src={images.started3} alt="female picture" className="w-[458px] sm:w-fit h-[375px] sm:h-fit" />
                </div>
            </div>
        </>
    );

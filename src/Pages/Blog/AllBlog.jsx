        ...
        <>
            <div className="flex flex-col items-center bg-[#F3F9F1] py-20">
                ...
                <div className="grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 px-2">
                        <div className="flex sm:hidden flex-col bg-[#fff] col-span-2 md:col-span-1 sm:col-span-1 bg-[url('/src/assets/roomInterior.png')] h-[446px] w-[757px] md:w-fit sm:w-fit  rounded-xl p-10 ">

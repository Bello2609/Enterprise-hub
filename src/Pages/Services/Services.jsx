            ...
            <div className="flex flex-col w-full">
                ...
                <div className="flex justify-evenly md:flex-col sm:flex-col  md:justify-center sm:justify-center md:items-center sm:items-center my-10 sm:my-5 w-full px-20 sm:px-10">
                    <div className="grid md:grid-cols-2 sm:grid-cols-1 grid-cols-4 gap-3 h-fit w-full">
                        <div
                            className="flex flex-col w-[280px] sm:w-[280px] h-[350px] bg-[#DFFFD4] p-5 mt-5 rounded-lg">
                        ...
                        <div
                            className="flex flex-col w-[280px] sm:w-[280px] h-[350px] bg-[#FBF6AF] p-5 mt-5 rounded-lg">
                        ...
                        <div
                            className="flex flex-col w-[280px] sm:w-[280px] h-[350px] bg-[#FFDEDD] p-5 mt-5 rounded-lg">
                        ...
                        <div
                            className="flex flex-col w-[280px] sm:w-[280px] h-[350px] bg-[#F0F0F0] p-5 mt-5 rounded-lg">

         ...
         <div className="flex flex-col w-full h-fit">
               ...
               <div className="basis-1/2">
                  <div className="flex flex-col  bg-[#56923E] p-20">
                     ...
                     <p className="w-[413px] flex-wrap font-normal text-base text-[#ffffff] my-4">
                        {`We've redefined the landscape for emerging enterprises
                        in Nigeria and beyond, offering a unique blend of online
                        and physical resource centers designed to propel your
                        business forward.`}
                     </p>
               ...
               <div className="grid grid-cols-4 gap-3 h-fit">
                  <div className="flex flex-col w-[220px] h-[fit] bg-[#DFFFD4] p-5 mt-5">
                     <img
                        ...
                        height="100px"
                     />
                     <h4 className="font-xl font-semibold font-sans mt-3">
                        Office Space
                     </h4>
                     <p className="w-[200px] my-3 text-[#252524] flex-wrap">
                        We have state of the art office spaces to cater for your
                        needs
                     </p>
                  ...
                  <div className="flex flex-col w-[220px] h-[fit] bg-[#FBF6AF] p-5 mt-5">
                     ...
                     <p className="w-[200px] my-3 text-[#252524] flex-wrap">
                        Take control of your business, by having a business
                        address in the heart of Lagos Nigeria.
                     </p>
                     <Link className="flex justify-center items-center w-[176px] h-[57px] text-[#fff] font-medium bg-[#E8332C] p-3 w-28 h-11 rounded-md ">
                        Book now
                     </Link>
                  ...
                  <div className="flex flex-col w-[220px] h-[fit] bg-[#FFDEDD] p-5 mt-5">
                     ...
                     <p className="w-[200px] my-3 text-[#252524] flex-wrap">
                        We support entrepreneurs, by offering professional
            ...
            <div className="bg-[url('/src/assets/interior.png')] w-full bg-no-repeat bg-center h-[506px] flex items-end">
               <div className="flex flex-col bg-[#C81F20] h-[435px] w-[633px] ml-16">
                  <div className="flex w-12 h-12 justify-end w-[633px]">
                     <div className="flex bg-[#E1D634] w-12 h-12"></div>
                  </div>
                  <div className="flex flex-col flex-wrap p-10 font-sans text-[#fff]">
                     <h4 className="text-3xl font-bold  flex-wrap w-[360px]">
                        A system that is redefining the way we live, work and
                        learn.
                     </h4>
                     <p className="text-base w-[533px] my-3">
                        Enterprise Hubs owned by Pedestal Africa Limited is an
                        integrated network of online and physical resource
                        centres for emerging enterprises in Nigeria and beyond.
                        A platform for promotion of businesses across Africa,
                        offering shared workspaces, virtual offices,
                        contemporary business hubs, online B2B marketplace,
                        business support services and a complete suite of
                        enterprise development services.
                     </p>
                     <div className="flex items-center">
                        <p className="text-base font-medium">More about us</p>
                        <span className="ml-3">
                           <FaArrowRightLong />
                        </span>
                     </div>
               ...
               <div className="basis-1/2">
                  <div className="flex flex-col h-full justify-center ml-16">
                     ...
                     <p className="text-base font-normal font-sans flex-wrap w-[510px] mt-5">
                        Enterprise Hubs has built a system to unleash
                        collaboration, creativity and inspiration from
                        passionate entrepreneurs and business people, most
                        especially a community that promotes learning,
                        collaboration and growth. Our evolutive virtual and
                        physical offices offer a highly functional
                        infrastructure, exceptional design that enhances your
            ...
            <div className="flex flex-col items-center bg-[#F3F9F1] py-10">
               ...
               <p className="text-base text-[#252524] font-normal font-sans flex-wrap w-[510px]">
                  Our private offices, dedicated desks, virtual offices and
                  co-working
               </p>
               ...
               <div className="grid grid-cols-4 mt-16">
                  <div className="flex flex-col items-center w-[187px] h-[182px] ">
                     <img
                        src={images.StateoftheartOffice}
                        alt="state of the art"
                        width="50px"
                        height="50px"
                     />
                     <p className="flex-wrap w-[145px] font-medium text-base text-[#616161] mt-5">
                        State of the art
                     </p>
                     <p className="flex justify-center w-[145px] font-medium text-base text-[#616161]">
                        Offices
                     </p>
                  </div>
                  <div className="flex flex-col items-center w-[187px] h-[182px] ">
                     <img
                        src={images.StateoftheartOffice1}
                        alt="state of the art"
                        width="50px"
                        height="50px"
                     />
                     <p className="flex justify-center w-[145px] font-medium text-base text-[#616161] mt-5">
                        Eco-friendly{" "}
                     </p>
                     <p className="flex justify-center w-[145px] font-medium text-base text-[#616161]">
                        Environment
                  ...
                  <div className="flex flex-col items-center w-[187px] h-[182px] ">
                     <img
                        src={images.flexibleMemberaship}
                        alt="state of the art"
                        width="50px"
                        height="50px"
                     />
                  ...
                  <div className="grid grid-cols-subgrid col-span-3">
                     <div className="col-start-2">
                        <div className="flex flex-col items-center w-[187px] h-[182px] ">
                           <img
                              src={images.PrintingScanningPhotocopying}
                              alt="state of the art"
                              width="50px"
                              height="50px"
                           />
